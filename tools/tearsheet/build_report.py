...
PARA01 = t(
    f"""The headline net is <strong>{r(H["combined"]["net"])}</strong> for the archived ladder comparison. Earlier exports and target-fill corrections below describe older research scenarios. Their differences cannot be subtracted from this headline to reconstruct its returns. <strong>Rebuilt 15 September 2026 on the rules deployed now</strong>: the put book exits on S1&ndash;S5 crossings and TC, both books square off at 15:10, S4/S5 use the traditional pivot formula, and exits are checked on each 5-minute close as the live engine checks them. The previous edition published &#8377;19,11,711 on the put book's earlier exits (S1&ndash;S3 and TC), checked on every 1-minute close. On the put book the two changes pull opposite ways: 5-minute checks add about &#8377;1.4 lakh, and the S4/S5 exits take about &#8377;2.7 lakh away.""",
    f"""தலைப்பு நிகரம் <strong>{r(H["combined"]["net"])}</strong> காப்பக படிநிலை ஒப்பீட்டுக்கானது. கீழுள்ள பழைய ஏற்றுமதி மற்றும் இலக்கு விலைத் திருத்தங்கள் முந்தைய ஆய்வுகளுக்கானவை; அவற்றின் வேறுபாடுகளைக் கழித்து இத்தலைப்பை மீண்டும் கணக்கிட முடியாது. <strong>15 செப்டம்பர் 2026 அன்று தற்போது இயங்கும் விதிகளில் மீண்டும் கணக்கிடப்பட்டது</strong>: PUT புத்தகம் S1&ndash;S5 கடப்புகள் மற்றும் TC-இல் வெளியேறுகிறது, இரு புத்தகங்களும் 15:10-இல் மூடப்படுகின்றன, S4/S5 பாரம்பரிய பிவோட் சூத்திரத்தில், வெளியேற்றங்கள் லைவ் என்ஜின் போல ஒவ்வொரு 5-நிமிட முடிவிலும் சோதிக்கப்படுகின்றன. முந்தைய பதிப்பு &#8377;19,11,711 &mdash; PUT புத்தகத்தின் பழைய வெளியேற்றங்களில் (S1&ndash;S3, TC), ஒவ்வொரு 1-நிமிட முடிவிலும் சோதித்தது. PUT புத்தகத்தில் இரு மாற்றங்களும் எதிர் திசையில்: 5-நிமிட சோதனை சுமார் &#8377;1.4 லட்சம் சேர்க்கிறது, S4/S5 வெளியேற்றங்கள் சுமார் &#8377;2.7 லட்சம் குறைக்கின்றன.""",
)
