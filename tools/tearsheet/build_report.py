...
PARA01 = t(
    f"""The headline net is <strong>{r(H["combined"]["net"])}</strong> for the archived ladder comparison. Earlier exports and target-fill corrections below describe older research scenarios. Their differences cannot be subtracted from this headline to reconstruct its returns. <strong>Rebuilt 15 September 2026 on the rules deployed now</strong>: the put book exits on S1&ndash;S3 crossings and TC, both books square off at 15:10, and exits are checked on each 5-minute close as the live engine checks them. The previous edition published &#8377;19,11,711 on the same put exits checked on every 1-minute close; 5-minute checks add about &#8377;1.4 lakh to the put book. S4 and S5 exits were tried on the put book and removed on 15 September 2026: at four lots they took about &#8377;2.7 lakh away, because on the few days the index kept falling they sold the put before the move finished.""",
    f"""தலைப்பு நிகரம் <strong>{r(H["combined"]["net"])}</strong> காப்பக படிநிலை ஒப்பீட்டுக்கானது. கீழுள்ள பழைய ஏற்றுமதி மற்றும் இலக்கு விலைத் திருத்தங்கள் முந்தைய ஆய்வுகளுக்கானவை; அவற்றின் வேறுபாடுகளைக் கழித்து இத்தலைப்பை மீண்டும் கணக்கிட முடியாது. <strong>15 செப்டம்பர் 2026 அன்று தற்போது இயங்கும் விதிகளில் மீண்டும் கணக்கிடப்பட்டது</strong>: PUT புத்தகம் S1&ndash;S3 கடப்புகள் மற்றும் TC-இல் வெளியேறுகிறது, இரு புத்தகங்களும் 15:10-இல் மூடப்படுகின்றன, வெளியேற்றங்கள் லைவ் என்ஜின் போல ஒவ்வொரு 5-நிமிட முடிவிலும் சோதிக்கப்படுகின்றன. முந்தைய பதிப்பு &#8377;19,11,711 &mdash; அதே PUT வெளியேற்றங்களை ஒவ்வொரு 1-நிமிட முடிவிலும் சோதித்தது; 5-நிமிட சோதனை PUT புத்தகத்துக்கு சுமார் &#8377;1.4 லட்சம் சேர்க்கிறது. S4, S5 வெளியேற்றங்கள் சோதிக்கப்பட்டு 15 செப்டம்பர் 2026 அன்று நீக்கப்பட்டன: நான்கு lots-இல் அவை சுமார் &#8377;2.7 லட்சம் குறைத்தன &mdash; குறியீடு தொடர்ந்து விழுந்த சில நாட்களில் நகர்வு முடியும் முன்பே PUT-ஐ விற்றன.""",
)
...
<section>
  ...
  <div class="cfg">
    <div class="cfg-card">
      ...
      <div class="cfg-rule"><b>{t("Exit", "வெளியேற்றம்")}</b>{LC["pe"]["exit_rule"]}</div>
    </div>
    <div class="cfg-card">
      ...
      <div class="cfg-rule"><b>{t("Exit", "வெளியேற்றம்")}</b>{LC["ce"]["exit_rule"]}</div>
    </div>
  </div>
